 ...
 {/*  <div className="hidden md:block absolute inset-0 z-0 scale-[1.0] origin-bottom-right hero-bg">
    ...
    />
      ...
      <div className="relative z-10 container flex flex-col md:flex-row items-center">
        <div className="w-full md:w-[44%] space-y-2 text-center md:text-left">
           <h2 className="text-[#000032] text-[32px] md:text-[30px] xl:text-[40px] font-bold leading-normal">
          GTC’s
        </h2>
  ...
  $10,000
        ...
        <h2 className="text-[#000032] text-[32px] md:text-[28px] xl:text-[40px] font-bold leading-tight px-5 md:px-0">
         ...
         <div className="block md:hidden relative w-full h-[264px] mb-[-40px]">
                  <Image src="/demo/full.webp" fill alt="GTC Trophy" className="object-contain" />
               </div>

        {/* Paragraph */}
        <p className="text-primary text-[14px] md:text-[16px] leading-relaxed py-5 px-5 md:px-0 mb-3 md:mb-0">
          ...
          Hit the button below to register your place and let’s see what you’re made of.
            ...
            <div className="flex flex-row justify-center md:justify-start items-center gap-4 md:pb-20 px-5 md:px-0">
              <CustomButton
