...
const generateEmailContentSupport = (data) => {
                    ...
                    <table role="presentation" cellspacing="0" cellpadding="0" border="0" style="border-radius: 36px; padding: 20px; background-color: #fff; width: 100%;">
                        ...
                        <tr>
                            <td class="content" style="width: 100%;">
                                ...
                                <p>A new query has been submitted through the Deposit Match Bonus form on our Demo Comp Trading. Please find the details below to follow up accordingly:</p>
                                ...
                                <table class="content-table" style="width: 100%; margin-top: 20px; border-collapse: collapse;">
                                    <tr>
                                        <th style="padding: 10px; text-align: left; background-color: #f2f2f2; color: #192055;">Account No</th>
