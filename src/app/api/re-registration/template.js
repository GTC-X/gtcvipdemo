...
<tr>
  <td align="center" style="font-size:14px;color:#4D4D70;padding-bottom:20px;">
    شكراً لتسجيلك معنا – سنذكرك عندما يفتح التسجيل
  </td>
</tr>
...
<tr>
  <td style="font-size:14px;color:#4D4D70;padding-bottom:10px;">
    شكراً لمشاركتك بياناتك معنا. 🎉
  </td>
</tr>
<tr>
  <td style="font-size:14px;color:#4D4D70;padding-bottom:10px;">
    أنت الآن على قائمتنا المميزة، وستكون أول من يعرف عندما يُعاد فتح التسجيل رسمياً في <strong>15 سبتمبر 2024</strong>.
  </td>
</tr>

<tr>
  <td style="font-size:14px;color:#4D4D70;padding-bottom:10px;">
    في هذه الأثناء، تابع بريدك الإلكتروني — سنرسل لك رسالة تذكير حتى لا تفوتك فرصة التسجيل فوراً.
  </td>
</tr>

<tr>
  <td style="font-size:14px;color:#4D4D70;padding-bottom:10px;">
    نحن متحمسون لانضمامك إلينا ونتطلع إلى الترحيب بك قريباً!
  </td>
</tr>
...
<tr>
  <td style="font-size:14px;color:#4D4D70;padding-bottom:30px;">
    أنت الأفضل، وقريباً ستُظهر للعالم ذلك!
    <br>
    عائلتك في GTC
  </td>
</tr>
...
<tr>
  <td align="center" style="font-size:14px;color:#4D4D70;padding-bottom:20px;">
    Gracias por registrarte – Te recordaremos cuando se abra el registro
  </td>
</tr>
...
<tr>
  <td style="font-size:14px;color:#4D4D70;padding-bottom:10px;">
    Gracias por compartir tus datos con nosotros. 🎉
  </td>
</tr>
<tr>
  <td style="font-size:14px;color:#4D4D70;padding-bottom:10px;">
    Ahora estás en nuestra lista prioritaria, y serás el primero en enterarte cuando el registro se reabra oficialmente el <strong>15 de septiembre de 2024</strong>.
  </td>
</tr>

<tr>
  <td style="font-size:14px;color:#4D4D70;padding-bottom:10px;">
    Mientras tanto, mantente atento a tu bandeja de entrada — te enviaremos un recordatorio para que no pierdas la oportunidad de registrarte de inmediato.
  </td>
</tr>

<tr>
  <td style="font-size:14px;color:#4D4D70;padding-bottom:10px;">
    ¡Estamos emocionados de tenerte con nosotros y esperamos darte la bienvenida pronto!
  </td>
</tr>
...
<tr>
  <td style="font-size:14px;color:#4D4D70;padding-bottom:30px;">
    ¡Eres el mejor, y pronto demostrarás al mundo que lo eres!
    <br>
    Tu familia GTC
  </td>
</tr>
...
<tr>
  <td align="center" style="font-size:14px;color:#4D4D70;padding-bottom:20px;">
    Obrigado por se inscrever – Vamos lembrá-lo quando o registro abrir
  </td>
</tr>
...
<tr>
  <td style="font-size:14px;color:#4D4D70;padding-bottom:10px;">
    Agora você está em nossa lista prioritária e será o primeiro a saber quando o registro for reaberto oficialmente em <strong>15 de setembro de 2024</strong>.
  </td>
</tr>

<tr>
  <td style="font-size:14px;color:#4D4D70;padding-bottom:10px;">
    Enquanto isso, fique de olho na sua caixa de entrada — enviaremos um lembrete para que você não perca a chance de se registrar imediatamente.
  </td>
</tr>

<tr>
  <td style="font-size:14px;color:#4D4D70;padding-bottom:10px;">
    Estamos muito animados por ter você conosco e esperamos recebê-lo em breve!
  </td>
</tr>
...
<tr>
  <td style="font-size:14px;color:#4D4D70;padding-bottom:30px;">
    Você é o melhor, e em breve mostrará ao mundo que é!
    <br>
    Sua família GTC
  </td>
</tr>
...
<html lang="en">
        ...
        <td align="center">
          ...
          <table width="650" cellpadding="0" cellspacing="0" style="border:1px solid #e0e0e0; border-top:none; border-radius:8px;padding:30px; padding-top: 0px">
           <!-- Logo -->
            ...
            <tr>
              <td align="center" style="font-size:14px;color:#4D4D70;padding-bottom:20px;">
                Thanks for Signing Up – We’ll Remind You When Registration Opens
              </td>
            </tr>
  ...
  <td style="border-top: 2px solid #e0e0e0; padding: 15px 0;"></td>
            ...
            <tr>
             ...
             <tr>
              <td style="font-size:14px;color:#4D4D70;padding-bottom:10px;">
            You are now on our priority list, and you’ll be the first to know as soon as registration officially reopens on <strong>15th September 2024</strong>.
              </td>
            </tr>
...
<!-- CTA Buttons -->
               ...
               <tr>
              <td style="font-size:14px;color:#4D4D70;padding-bottom:10px;">
           In the meantime, keep an eye on your inbox — we’ll send you a reminder email so you don’t miss the chance to register right away.
               ...
               <tr>
              <td style="font-size:14px;color:#4D4D70;padding-bottom:10px;">
          We’re excited to have you with us and look forward to welcoming you soon!
